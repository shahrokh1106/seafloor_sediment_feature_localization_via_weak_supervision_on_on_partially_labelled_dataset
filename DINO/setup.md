...
The annotation acceleration workflow in this `DINO/` folder is built on top of the official **DINOv3** implementation from Meta AI.
...
Before running scripts in this folder (for example `dinov3.py`), you should clone and install the official DINOv3 repository according to its setup instructions.
